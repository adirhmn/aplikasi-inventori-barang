...
class ViewDataBarangGuest:
    ...
    def Frame(self):
        ...
        self.btnDataLaporan=Button(MenuFrame, text="Tentang Kami", font=('arial', 16, 'bold'), height=1, width=10, bd=4, relief=FLAT, bg="#20B2AA")
...
def main():
    root=Tk()
    application=ViewDataBarangGuest(root)
    root.mainloop()
