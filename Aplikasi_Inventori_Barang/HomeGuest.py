...
class HomeGuest:
    ...
    def Frame(self):
        ...
        self.btnDataLaporan=Button(ButtonFrame, text="Tentang Kami", font=('arial', 16, 'bold'), height=1, width=10, bd=4, relief=FLAT, bg="#20B2AA")
