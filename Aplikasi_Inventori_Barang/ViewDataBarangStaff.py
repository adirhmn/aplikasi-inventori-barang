...
class ViewDataBarangStaff:
    ...
    def Frame(self):
        ...
        self.btnDataUser=Button(MenuFrame, text="Tentang Kami", font=('arial', 16, 'bold'), height=1, width=10, bd=4, relief=FLAT, bg="#20B2AA")
...
def main():
    root=Tk()
    application=ViewDataBarangStaff(root)
    root.mainloop()
